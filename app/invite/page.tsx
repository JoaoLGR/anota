...
export default function InvitePage() {
  ...
  if (!ready) return <main className="flex min-h-screen items-center justify-center bg-[#fafafc] dark:bg-zinc-950"><Loader2 className="animate-spin text-lilac-500"/></main>;
