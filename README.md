...
O cadastro público fica desativado no Supabase. Para liberar um usuário, abra `Authentication → Users → Add user → Invite user` no projeto Supabase e informe o e-mail. O usuário receberá o convite por e-mail e poderá definir a senha antes de entrar em `https://anota-two.vercel.app`.
